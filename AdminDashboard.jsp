...
<body>
    <header>
        ...
        <nav class="navbar">
		   <h3 >WELLCOME <%= request.getAttribute( "username") %></h3>
    ...
    <div class="container-fluid" style="padding-top:100px;">
        <div class="row" style="display: flex;">
            <div class="col-md-4">
                <div class="cardBox">
                    <div class="card">
                        <div class="numbers"><%= request.getAttribute("Studenttotal") %></div>
                ...
                <div class="cardBox">
                    <div class="card">
                        <div class="numbers"><%=request.getAttribute("Facultytotal") %></div>
